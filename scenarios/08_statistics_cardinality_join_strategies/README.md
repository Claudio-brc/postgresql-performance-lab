...
- PostgreSQL
- Docker
- Node.js (dataset preprocessing)
- DBA Stack Exchange Dataset
...
The Stack Exchange dataset is not included in this repository.

Download the dataset separately and place the extracted files inside:
...
Run the dataset preprocessing and import scripts located in the `scripts` directory.

The exact workflow may vary depending on the dataset version and local environment.
